...
public class HydraPoison extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        ...
        if (!level.isClientSide) {
            ...
            entity.addEffect(new MobEffectInstance(MobEffects.POISON, EFFECT_DURATION + (int)((RANDOM.nextDouble() - 0.2)*100), AMPLIFIER, false, false, true));
        }
