...
import ru.pb.ahfgc.spells.ice.PermafrostGateSpell;
...
public class SpellRegistry {
    private static final DeferredRegister<AbstractSpell> SPELLS = DeferredRegister.create(SPELL_REGISTRY_KEY, AHFGCMod.MOD_ID);
